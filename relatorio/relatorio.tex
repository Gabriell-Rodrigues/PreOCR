...
\usepackage[utf8]{inputenc}    % Reconhece caracteres acentuados
\usepackage[T1]{fontenc}       % Essencial para hifenização correta em PT-BR e cópia de texto
\usepackage[portuguese]{babel} % Define o idioma do documento

% --- Fonte (Padrão ABNT) ---
\usepackage{mathptmx}          % Usa fonte equivalente à Times New Roman

% --- Margens (Padrão ABNT) ---
\usepackage{geometry}
\geometry{top=3cm, left=3cm, bottom=2cm, right=2cm}

% --- Espaçamento (Padrão ABNT) ---
\usepackage{setspace}
\onehalfspacing                % Define espaçamento de 1,5 entre as linhas

% --- Parágrafos (Padrão ABNT) ---
\usepackage{indentfirst}       % Indenta o primeiro parágrafo de cada seção
\setlength{\parindent}{1.25cm} % Define o recuo do parágrafo para 1,25 cm
...
% --- Links e Referências ---
\usepackage[hidelinks]{hyperref} % Necessário para o \href funcionar e para links no sumário
...
\section{COMPILAÇÃO E EXECUÇÃO NO LINUX}
...
\bibitem{b3}
POSKANZER, J. \textbf{PBM Format Specification}. Netpbm documentation. Disponível em: \url{https://netpbm.sourceforge.net/doc/pbm.html}. Acesso em: 15 jul. 2026.
